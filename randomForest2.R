...
############~~~~~~nombre d'arbre = 2 ~~~~~~~~~~~~~~~~~###############
#passer nos donnees par une matrice permet d'eviter de faire deborder la pile
memory.limit(size=8000000)
options("expressions"=12e4)
foret = randomForest(classe~., data = donnee_test, ntree = 2, norm.votes=FALSE)
